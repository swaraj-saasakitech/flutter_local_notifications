    ...
    protected static Notification createNotification(
        ...
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(),
                VERSION.SDK_INT > VERSION_CODES.Q
                        ? R.layout.custom_notification_layout : R.layout.custom_notification_layout2);
        ...
        if(VERSION.SDK_INT <= VERSION_CODES.Q){
            remoteViews.setImageViewResource(R.id.logo,getDrawableResourceId(context, "@mipmap/notification_icon"));
            remoteViewsBig.setTextViewText(R.id.brandName,"Reveal Inside • ");
